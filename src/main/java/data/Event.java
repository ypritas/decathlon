...
public enum Event {
    ...
    EVENT_LONG_JUMP(2, "Long_jump", 0.14354f, 220f, 1.4f, EventType.Field, MeasurementType.Centimeters),
    EVENT_SHOT_PUT(3, "Shot_put", 51.39f, 1.5f, 1.05f, EventType.Field, MeasurementType.Meters),
    EVENT_HIGH_JUMP(4, "High_jump", 0.8465f, 75f, 1.42f, EventType.Field, MeasurementType.Centimeters),
    ...
    EVENT_POLE_VAULT(8, "Pole_vault", 0.2797f, 100f, 1.35f, EventType.Field, MeasurementType.Centimeters),
